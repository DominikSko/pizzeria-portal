...
/* thunk creators */   //  dodanie thunka (a właściwie jego kreatora)
export const fetchProductsFromAPI = () => {        // Zwraca ona thunka, czyli funkcję. Thunk przyjmuje dwa argumenty – dispatch i getState. Pierwszy z nich, podobnie jak w mapDispatchToProps w kontenerze komponentu, jest funkcją służącą do dispatchowania akcji. Drugi, getState, jest funkcją pozwalającą na pobranie stanu aplikacji.
